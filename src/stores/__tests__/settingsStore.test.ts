...
describe('settingsStore', () => {
  ...
  describe('updateSetting', () => {
    ...
    it('should preserve other settings when updating one', () => {
      ...
      expect(state.settings.skipForwardSeconds).toBe(originalSettings.skipForwardSeconds);
      expect(state.settings.skipBackwardSeconds).toBe(originalSettings.skipBackwardSeconds);
